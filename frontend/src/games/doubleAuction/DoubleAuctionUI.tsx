...
/**
 * Double Auction game UI — the order book, bid/ask forms, and trade feed.
 * This is the original game UI, extracted from Market.tsx.
 */
const DoubleAuctionUI: React.FC<DAGameUIProps> = ({
  player,
  playerId,
  roundId,
  roundActive,
...
export default DoubleAuctionUI;
