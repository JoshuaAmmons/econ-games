    ...
    return {
      ...
      configFields: [
        ...
        },
        {
          ...
          min: 5,
          max: 200,
          description: 'Max output when fully specialized in advantaged good (paper: ~130)',
        },
        {
          ...
          min: 1,
          max: 100,
          description: 'Max output when fully specialized in non-advantaged good (paper: ~23)',
        },
        {
        ...
        },
        {
          ...
          max: 10,
          step: 0.1,
          description: 'Type A needs k units of good1 per unit of good2 (paper: 3)',
        },
        {
          name: 'ratio_type_b',
